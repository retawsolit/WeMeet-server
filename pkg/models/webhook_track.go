...
func (m *WebhookModel) trackPublished(event *livekit.WebhookEvent) {
	...
	case livekit.TrackSource_MICROPHONE:
		...
		data.EventName = wemeet.AnalyticsEvents_ANALYTICS_EVENT_USER_MIC_STATUS
	case livekit.TrackSource_CAMERA:
		val = wemeet.AnalyticsStatus_ANALYTICS_STATUS_STARTED.String()
		data.EventName = wemeet.AnalyticsEvents_ANALYTICS_EVENT_USER_WEBCAM_STATUS
	case livekit.TrackSource_SCREEN_SHARE,
		livekit.TrackSource_SCREEN_SHARE_AUDIO:
		val = wemeet.AnalyticsStatus_ANALYTICS_STATUS_STARTED.String()
		data.EventName = wemeet.AnalyticsEvents_ANALYTICS_EVENT_USER_SCREEN_SHARE_STATUS
	}
	data.HsetValue = &val
